...
(function (D, aa) {
    ...
    X = function (a, b, c) {
        ...
        h;
        if (g) b ? (f = g[b] || [], c ? (h =
        sa(c, f), h > - 1 && (f.splice(h, 1), g[b] = f), d(b, c))  : (e(), g[b] = [
        ]))  : (e(), a.hcEvents = {
        })
    };
    I = function (a, b, c, d) {
    ...
    U = {
        ...
        tooltip: {
            ...
            footerFormat: '',
            headerFormat: '<span style="font-size: 15px;font-weight:600">{point.key}</span><br>',
            pointFormat: '<span style="color:{point.color}">● </span> <span style="font-size:15px">{series.name} {point.y}</span><br/>',
            shadow: false,
            snap: Lb ? 25 : 10,
            style: {
                color: '#262932',
    ...
    Da.prototype = {
        ...
        symbol: function (a, b, c, d, e, f) {
            ...
            j = a.match(k) [1],
            a = Mb[j] || f && f.width && f.height && [f.width,
            f.height],
            h = this.image(j).attr({
                x: b,
                y: c
    ...
    ha.prototype = {
        ...
        setTickInterval: function (a) {
            ...
            !i && r(b.min) && r(b.max) && (f = b.max - b.min)) !r(w) && j && (b.min -= f * j),
            !r(v) && k && (b.max += f * k);
    ...
    R.prototype = {
        ...
        setClip: function (a) {
            ...
            f = this.clipBox,
            g = f || b.clipBox,
            h = this.sharedClipKey || ['_sharedClip',
            a && a.duration,
            a && a.easing,
            g.height,
            c.xAxis,
