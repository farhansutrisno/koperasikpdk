   ...
   <body>
      ...
      <div class="container"> 
        ...
        <div class="pay-method">
            ...
            <div class="col-md-6"> 
              ...
              <div class="heading">
                ...
                <div class="row"> 
                  ...
                  <div class="col-sm-6">
                    <label>Tanggal Lahir
                      <input class="form-control datepicker" style="width:240px;" size="10" data-date-format="yyyy-mm-dd" type="text" name="tglLahir" value="<?php echo $profil[0]->tglLahir ?>" required>
                  ...
                  <div class="col-sm-6">
                    <label>Gambar</label>
                          <img src="<?php echo base_url() ?>gambar_proyek/<?php echo $profil[0]->foto ?>" height="70px" width="90px" >
                          <input class="form-control" type="file" name="userfile" value="<?php echo $profil[0]->foto ?>">
          ...
          <div class="pro-btn">
                    <?php echo anchor('C_produkPembeli/lihatProduk','K E M B A L I',array('class'=>'btn-round btn-light'));?>
