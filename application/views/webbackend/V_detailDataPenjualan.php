    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h5 class="page-title">Lihat Detail Penjualan <small>Koperasi KPDK 12 Juli </small> </h5><br>
              <div class="row">
                <div class="col-md-6">
                    <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr><th>Kd Pembelian</th><td><?php echo $row[0]->kdPembelian ?></td>
                        <tr><th>Id Akun</th><td><?php echo $row[0]->idAkun ?></td></tr>
                        <tr><th>Kd Pembayaran</th><td><?php echo $row[0]->kdPembayaran ?></td></tr>
                        <?php foreach ($row as $row1) { ?>
                        <tr><th>Kd Produk</th><td><?php echo $row1->kdProduk ?> Jumlah = <?php echo $row1->jml_produk ?></td></tr>
                        <?php } ?>
                        <tr><th>Total Bayar</th><td>Rp.<?php echo number_format($row[0]->totalBayar, 0,",",".") ?></td></tr>
                        <tr><th>Kurir</th><td><?php echo $row[0]->kurir ?></td></tr>
                        <tr><th>Biaya kirim</th><td>Rp.<?php echo number_format($row[0]->biayaKirim, 0,",",".") ?></td></tr>
                ...
                <div class="col-md-6">
                    <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr><th>Tgl Transaksi</th><td><?php echo $row[0]->tglTransaksi ?></td></tr>
                        <tr><th>Tgl Pembayaran</th><td><?php echo $row[0]->tglPembayaran ?></td></tr>
                        <tr><th>No Resi</th><td><?php echo $row[0]->noResi ?></td></tr>
                        <tr><th>Status Pembelian</th><td><?php echo $row[0]->statusPembayaran ?></td></tr>
                        <tr><th>Catatan</th><td><?php echo $row[0]->catatan ?></td></tr>
                        <tr><th>Kd Operator</th><td><?php echo $row[0]->kdOperator ?></td></tr>
                        <tr><th>Kd Unik</th><td><?php echo $row[0]->kodeUnik ?></td></tr>
                        <tr><th>Struk Pembayaran</th><td></td></tr>
                       
                    </table>
                  </div>
                    <img src="<?php echo base_url().'gambar_proyek/'.$row[0]->strukPembayaran ?>" width="450px" height="500px">
                </div>
