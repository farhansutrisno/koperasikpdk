    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h5 class="page-title">Lihat Detail Produk <small>Koperasi KPDK 12 Juli </small> </h5><br>
              <div class="row">
                <div class="col-md-6">
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr><th>Kd Produk</th><td><?php echo $row[0]->kdProduk ?></td>
                        ...
                        <tr><th>Harga Penjualan</th><td>Rp.<?php echo  number_format($row[0]->hargaPenjualan, 0,",","."); ?></td></tr>
                ...
                <div class="col-md-6">
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                      ...
                      <tr><th>TglPembelian</th><td><?php echo $row[0]->tglPembelian ?></td></tr>
                      <tr><th>Expired</th><td><?php echo $row[0]->expired ?></td></tr>
                      <tr><th>Gambar Produk</th><td></td></tr>
