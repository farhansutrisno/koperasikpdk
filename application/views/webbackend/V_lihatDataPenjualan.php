    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h5 class="page-title">Lihat Data Penjualan <small>Koperasi KPDK 12 Juli </small> </h5><br>
                    
                    <?php
                    echo anchor('webbackend/C_dataPenjualan/exportAll','Export All Excel ',array('class'=>'btn btn-round btn-success'));
                    ?>
                    ...
                    <form action="<?php echo base_url().'webbackend/C_dataPenjualan/dataFilter'?>" method="POST">
                      ...
                      <input type="submit" name="submit" class="btn btn-round btn-success" value="Export Excel Filter" >
                    </form>
                    <br><br>
              <div class="row">
                      ...
                      <?php
                        $no=1;
                            foreach ($penjualan as $key){
                                echo "<tr>";
                                echo "<td>". $no++."</td>";
                                echo "<td>". $key->idAkun."</td>";
                                echo "<td>". $key->kdPembayaran."</td>";
                                echo "<td>Rp.".number_format($key->totalBayar, 0,",",".")."</td>";
                                echo "<td>". $key->statusPembayaran."</td>";
                                echo "<td>". $key->tglTransaksi."</td>";
                                echo "<td>". $key->tglPembayaran."</td>";
                      ?>
                                <td>
                                    <a href="<?php echo base_url().'webbackend/C_dataPenjualan/detailDataPenjualan2/'.$key->kdPembayaran?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                                    <a href="<?php echo base_url().'webbackend/C_dataPenjualan/updateDataPenjualan/'.$key->kdPembayaran?>" class="btn btn-primary">
