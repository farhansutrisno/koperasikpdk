    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h5 class="page-title">Lihat Detail Pesan Masuk <small>Koperasi KPDK 12 Juli </small> </h5><br>
              <div class="right_col" role="main">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                    <tr><td>Kd Pesan Masuk</td><td><?php echo $row[0]->kdPesanMasuk ?><tr></tr>
                    <tr><td>Nama Lengkap</td><td><?php echo $row[0]->namaLengkap ?><tr></tr>
                    <tr><td>No. Telepon</td><td><?php echo $row[0]->noTelepon ?><tr></tr>
                    <tr><td>Waktu Pesan</td><td><?php echo $row[0]->tglPesan ?><tr></tr>
                    <tr><td>Judul Pesan</td><td><?php echo $row[0]->judulPesan ?><tr></tr>
                    <tr><td>Isi Pesan</td><td><?php echo $row[0]->isiPesan ?><tr></tr>
                </table>
              </div>
