            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Approval atau Di ACC</h4>
                  <br>
                  <hr>
                   <form method="POST" action="<?php echo base_url().'webbackend/C_dataPenjualan/prosesUpdateDataPenjualan'?>" name="updateDataPenjualan" >
                    ...
                    <input type="hidden" class="form-control" name="kdPembayaran" value="<?php echo $penjualan[0]->kdPembayaran ?>" />
                    <fieldset>
                      <div class="form-group">
                          <label>No Resi</label>
                          <input type="number" class="form-control" name="noResi" value="<?php echo $penjualan[0]->noResi ?>" required />
                          <?php echo set_value('noResi') ?><br><?php echo form_error('noResi'); ?>
                      </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Tidak Approval atau Tidak Di ACC</h4>
                  <br>
                  <hr>
                   <form method="POST" action="<?php echo base_url().'webbackend/C_dataPenjualan/prosesUpdateDataPenjualan2'?>" name="updateDataPenjualan2" >
                    <?php 
                      $kdoperator = $this->session->userdata('kodeOperator');
                    ?>
                    ...
                    <fieldset>
                      ...
                      <div>
                        <label>Catatan</label>
                          <textarea required class="form-control" name="catatan" rows="5"><?php echo $penjualan[0]->catatan ?></textarea>
