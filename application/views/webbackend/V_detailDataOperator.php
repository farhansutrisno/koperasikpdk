    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h5 class="page-title">Lihat Detail Operator <small>Koperasi KPDK 12 Juli </small> </h5><br>
              <div class="row">
                <div class="col-md-6">
                    <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr><th>Kd Operator</th><td><?php echo $row[0]->kdOperator ?></td>
                        ...
                        <tr><th>Tanggal Lahir</th><td><?php echo $row[0]->tglLahir ?></td></tr>
