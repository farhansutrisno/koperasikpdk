              ...
              <div class="product">
                <article>                   
                  ...
                  <div class="media-left">
                    <div class="item-img"> <img class="img-responsive" src="<?php echo base_url() ?>gambar_proyek/<?php echo $allTransaksi->strukPembayaran ?> " >  </div>
                  </div>                  
                    ...
                    <div class="row">                       
                        ...
                        <ul class="bullet-round-list">
                          <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                <tr><th>Total Bayar</th><td>Rp.<?php echo  number_format($allTransaksi->totalBayar, 0,",","."); ?></td></tr>
                                <tr><th>Kode Tagihan</th><td><?php echo $allTransaksi->kdPembayaran; ?></td></tr>
                                <tr><th>Kode Tagihan2</th><td><?php echo $allTransaksi->kodeUnik; ?></td></tr>
                                <tr><th>Tanggal Transaksi</th><td><?php echo $allTransaksi->tglTransaksi; ?></td></tr>
                                <tr><th>No Resi</th><td><?php echo $allTransaksi->noResi; ?></td></tr>
                                <tr><th>Status Pembayaran</th><td><?php echo $allTransaksi->statusPembayaran; ?></td></tr>
                                <!-- <tr><th>Nama Produk</th><td><?php echo $allTransaksi->namaProduk; ?></td></tr> -->
                      ...
                      <div class="col-sm-5 text-center"> 
                        <div class="position-center-center">
                          ...
                          <?php echo anchor('C_transaksiProduk/lihatTransaksi/'.$allTransaksi->kodeUnik,'Lihat Detail Transaksi',array('class'=>'btn-round btn-light'));?>
                      </div>
                    </div>
                  </div>
                </div>
