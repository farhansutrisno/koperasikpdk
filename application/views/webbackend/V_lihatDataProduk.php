    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
             <h5 class="page-title">  Lihat Data Produk <small>Koperasi KPDK 12 Juli </small></h5><br>
              <div class="row">
                ...
                <div class="col-12 page-header-title">
                    ...
                    ?>
                    <?php
                    echo anchor('webbackend/C_dataProduk/exportAll','Export All Excel ',array('class'=>'btn btn-round btn-success'));
                    ?>
                    <br><br>
