        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Update Data Produk</h4>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="berat" value="<?php echo $produk[0]->berat ?>" required/>
                          <?php echo set_value('berat') ?><br><?php echo form_error('berat'); ?>
                      </div>
                    <div class="form-group">
                          <label>Kategori</label>
                          <select class="form-control" type="text" name="kategori" required> 
                              <option><?php echo $produk[0]->kategori ?></option>
                      ...
                      <div class="form-group">
                          <label>Expired</label>
                          <div>
                              <input class="form-control datepicker" data-date-format="yyyy-mm-dd" type="text" name="expired" value="<?php echo $produk[0]->expired ?>"> 
                              <?php echo set_value('expired') ?><br><?php echo form_error('expired'); ?>
                          </div>
                      </div>
                      <div class="form-group">
                          <label>Tanggal Pembelian</label>
                          <div>
                              <input class="form-control datepicker" data-date-format="yyyy-mm-dd" type="text" name="tglPembelian" value="<?php echo $produk[0]->tglPembelian ?>" required> 
                              <?php echo set_value('tglPembelian') ?><br><?php echo form_error('tglPembelian'); ?>
                          </div>
                      </div>
                      <div class="form-group">
